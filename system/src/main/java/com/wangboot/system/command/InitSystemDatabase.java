...
public class InitSystemDatabase extends BaseInitDatabaseCommand {
  ...
  private int syncPermission() {
    ...
    // 添加其他策略
    data2.add(new SysPolicy(AdditionalPolicyIds.POLICY_MANAGE_MENU, AdditionalPolicyIds.POLICY_MANAGE_MENU, "管理功能菜单", true, null, null, null));
    data2.add(new SysPolicy(AdditionalPolicyIds.POLICY_COMMON_MENU, AdditionalPolicyIds.POLICY_COMMON_MENU, "通用功能菜单", true, null, null, null));
    data2.add(new SysPolicy(AdditionalPolicyIds.POLICY_FILE, AdditionalPolicyIds.POLICY_FILE, "通用文件策略", true, null, null, null));
    ...
    // 其他策略权限关系
    data3.add(PermissionGenerator.createPolicyPermissionRel(AdditionalPolicyIds.POLICY_FILE, attachmentUpload));
    data3.add(PermissionGenerator.createPolicyPermissionRel(AdditionalPolicyIds.POLICY_FILE, attachmentView));
    data3.add(PermissionGenerator.createPolicyPermissionRel(AdditionalPolicyIds.POLICY_FILE, attachmentDownload));
    ...
    List<SysPolicyMenuRel> data4 =
      Arrays.asList(
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.HOME),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.DASHBOARD),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.ORGANIZATION),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.USER_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(
          AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.DEPARTMENT_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.JOB_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.PERMISSION),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.ROLE_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.POLICY_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(
        ...
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.SYSTEM),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.MENU_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.FRONTEND_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(
          AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.ANNOUNCEMENT_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.USER_DICT_MANAGEMENT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.SUPPORT),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.USER_LOG),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_MANAGE_MENU, MenuIds.OPERATION_LOG),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_COMMON_MENU, MenuIds.HOME),
        PermissionGenerator.createPolicyMenuRel(AdditionalPolicyIds.POLICY_COMMON_MENU, MenuIds.DASHBOARD));
    ...
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.SYSTEM_ID, AdditionalPolicyIds.POLICY_MANAGE_MENU));
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.SYSTEM_ID, AdditionalPolicyIds.POLICY_FILE));
    // 系统审计员
    this.permissionGenerators.forEach(
      g ->
        data6.add(
          PermissionGenerator.createRolePolicyRel(RoleIds.AUDIT_ID, g.getReadPolicyId())));
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.AUDIT_ID, AdditionalPolicyIds.POLICY_MANAGE_MENU));
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.AUDIT_ID, AdditionalPolicyIds.POLICY_FILE));
    // 普通后台用户
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.COMMON_ID, AdditionalPolicyIds.POLICY_COMMON_MENU));
    data6.add(PermissionGenerator.createRolePolicyRel(RoleIds.COMMON_ID, AdditionalPolicyIds.POLICY_FILE));
