...
public class AnalysisManager {
  ...
  public List<ChatCompletionsResponseBody.Choice> analysisIndicators(
      byte[] bytes, String filename, String contentType) throws IOException {
    ...
    ChatMessage chatMessage1 =
        new ChatMessage("system", "你是一个专业且高效的文档分析助理，能够精准地为用户阅读报告并准确提取其中的关键主要指标。");
    ...
    ChatCompletionsRequestBody body =
        new ChatCompletionsRequestBody(
            "moonshot-v1-8k", Arrays.asList(chatMessage1, chatMessage2, chatMessage3), 0.3);
